<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
    ...
    <button type="button" class="btn btn-success btn-icon btn-edit-department" data-toggle="tooltip"
        data-placement="top" title="" data-original-title="Edit" data-edit="{{route('department.edit', $row->id )}}">
