  ...
  <div class="container-fluid logs-container">
    <div class="row">
      ...
      <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="list-group">
          <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="?l=<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($file)); ?>" class="list-group-item <?php if($current_file == $file): ?> llv-active <?php endif; ?>">
              <?php echo e($file); ?>
      ...
      <div class="col-sm-9 col-md-10 table-container">
        ...
        <div>
          <?php if($current_file): ?>
            <a href="?dl=<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($current_file)); ?>" class="btn btn-link">
              <i class="fa fa-download" aria-hidden="true"></i>
              Download file
            </a>
            -
            <a id="delete-log" data-toggle="modal" data-target="#confirmDelete" data-href="?del=<?php echo e(\Illuminate\Support\Facades\Crypt::encrypt($current_file)); ?>" data-title="Delete Log File" data-message="Are you sure you want to delete log file?" class="btn btn-link">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/productive/resources/views/vendor/laravel-log-viewer/log.blade.php ENDPATH**/ ?>