    ...
    * */
    ...
    function loadModal() {
        ...
        $(modal).on("shown.bs.modal", function (e) {
            axios.get(modalProperties.actioUrl)
    ...
    $("body").on("click", "#btn-new-department", function (ev) {
        ev.preventDefault();
        modalProperties.actioUrl = $(this).data('create');
        loadModal();
    });
    ...
    $("body").on("click", "#btn-modal-save", function (ev) {
        ...
        let createUrl = $(modal).find('form').attr('action');

        var deptdata = new FormData();
        deptdata.set('depratment_name', $(modal).find('#name').val());
